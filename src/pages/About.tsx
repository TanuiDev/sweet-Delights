...
import { MdBakeryDining, MdOutlineLocalShipping, MdOutlineCelebration, MdSupportAgent } from "react-icons/md";
      ...
      <div className="items-center justify-center flex flex-col text-center  space-y-6 px-4">
        ...
        <div className="card  mt-4 rounded-lg bg-gray-800 p-6">
          <p className="text-white text-lg sm:text-xl md:text-2xl">
            Founded in 2025, SweetDelights began with a simple mission: to make
