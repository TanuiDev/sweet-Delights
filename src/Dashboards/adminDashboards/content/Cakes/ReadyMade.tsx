              ...
              res.map((cake) => {
                ...
                return (
                  <div
                    ...
                    key={cake.cakeId}
                    className="bg-white rounded-2xl shadow-xl duration-300 overflow-hidden border border-gray-100 hover:border-purple-200 transform hover:-translate-y-1 group"
                  >
